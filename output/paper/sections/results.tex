...
\begin{figure}[htbp]
    ...
    \caption[AR bias]{Aggregated estimates for AR parameter of time series with added noise}
    \label{fig:ar_bias}
\end{figure}
...
Now in order to assess the efficacy of this method, $ \simsfearma $ simulations were conducted with 
...
\subsection{Case Study: mVAM Data in Honduras}
...
The REMARCS algorithm was also applied to mVAM data from the same time period in Yemen \cite{Argentino2026review}. 


\subsection{To-Do List}
\begin{itemize}
    \item Comment on missing values
    \item Exclude veta from confidence regions for right panel of REMARCS simulations
    \item Synchronize color ranges for T1 and T2 of ARMAN simulations, L1 and L2 of REMARCS simulations
    \item Rownames, aesthetics, captions of tables
\end{itemize}