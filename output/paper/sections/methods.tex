...
Equipped with the above estimates, Wong and Miller detail how to estimate
 ...
 autocovariance functions of $\uu$ and $\mathbf{w}$ through the system 
...
Those intercepts are then used to update the parameters of $\Sigma_b$, using the formula
INSERT FORMULA HERE. A flowchart depicting the steps of the algorithm is given in 
